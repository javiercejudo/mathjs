...
module.exports = function (math, config) {
  ...
  if (config.number === 'bignumber') {
    ...
    object.lazy(math, 'LN2',     function () {return new BigNumber(new BigNumber('2').val().ln().toString())});
    object.lazy(math, 'LN10',    function () {return new BigNumber(new BigNumber('10').val().ln().toString())});
    object.lazy(math, 'LOG2E',   function () {return new BigNumber('1').div(new BigNumber(new BigNumber('2').val().ln().toString()));});
    object.lazy(math, 'LOG10E',  function () {return new BigNumber('1').div(new BigNumber(new BigNumber('10').val().ln().toString()))});
    object.lazy(math, 'PI',      function () {return math.pi});
    object.lazy(math, 'SQRT1_2', function () {return new BigNumber(new BigNumber('0.5').val().sqrt().toString())});
    object.lazy(math, 'SQRT2',   function () {return new BigNumber(new BigNumber('2').val().sqrt().toString())});
  }
  else {
